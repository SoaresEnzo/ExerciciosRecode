...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Tgr_ItensVenda_Insert` AFTER INSERT ON `itensvenda` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Tgr_ItensVenda_Delete` AFTER DELETE ON `itensvenda` FOR EACH ROW BEGIN
...
-- Dump completed on 2020-10-19 14:05:25
